function [clickcount, t] = GUIshoal2dv5_5_practice(n) %CHANGED 12/11/2004 
% input variables
...
h3 = quiver(arrow(1),arrow(2),arrow(3),arrow(4),3,'r');  % this plots the arrow to point to a particular prey item, change the number before 'r' to adjust the length of the arrows
