function [clickcount, t] = GUIshoal2dv5_4(n,Nhet,Target,Density,Isolate) %CHANGED 12/11/2004 
% input variables
...
if Target
    focus_prey = ceil(rand.*het); % pick a hetero prey item at random to follow
else
    focus_prey = ceil(rand.*hom); % pick a homo prey item at random to follow
end
