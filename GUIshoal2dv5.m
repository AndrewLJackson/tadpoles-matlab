function GUIshoal2dv5%(n,Rr,Ro,Ra,aa,v,dtheta,sigma,trials);
...
h1 = plot(C(1,:),C(2,:),'o','markersize',5,'markeredgecolor',[0 0 0.8],'markerfacecolor',[0 0 0.8]); %plots the dots
hold on
h2 = plot(uu(:),vv(:),'k'); %plots the tails
hold off
h = [h1 h2];
axis ([-20 20 -20 20])
axis square
...
pb1 = uicontrol('Style', 'pushbutton', 'String', 'GO AGAIN',...
    'Position', [10 10 100 40],'units','pixels', 'Callback', 'GUIshoal2dv5');
