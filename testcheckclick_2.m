function [GotOne] = testcheckclick_2; %changed 12/11/2004
%tests to see if a mouse click captures a prey
%also records the number of clicks made during a simulation

global C xy GotOne clickcount t preypositionX preypositionY cursorposition %these variables are global i.e. available to all functions in the workspace.
...
if s(1) <= 0.85 %was 0.4 changed 15/11/2004 19/11 changed from 0.6
    nearest = I(1);
else
    nearest = [];
end
